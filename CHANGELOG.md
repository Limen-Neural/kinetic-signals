...
- Dropped the Qodana GitHub Actions workflow and `QODANA_TOKEN` / `QODANA_ENDPOINT` usage after membership expired. Remaining CI gates are fmt, clippy, tests, coverage, Docker, and cargo-audit.
